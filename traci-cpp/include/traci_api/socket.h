...
// Dummy function is called when Shawn Simulation starts. Does nothing up to
// now.
...
class Socket {
 ...
 public:
  ...
  /// @note This is done by binding a socket with port=0, getting the assigned
  /// port, and closing the socket again
