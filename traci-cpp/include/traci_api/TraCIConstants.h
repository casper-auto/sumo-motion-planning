...
// ****************************************
// return value for invalid queries (especially vehicle is not on the road), see
// Position::INVALID
...
// Routing modes
// ****************************************
// use custom weights if available, fall back to loaded weights and then to
// free-flow speed
...
// Exclude vehicles on opposite (and other) lanes from context subscription
// result
#define FILTER_TYPE_NOOPPOSITE 0x02

// Specify maximal downstream distance for vehicles in context subscription
// result
...
// Only return leader and follower on the specified lanes in context
// subscription result
